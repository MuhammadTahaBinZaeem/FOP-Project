...
const packages=[
  ['pocket-engineer-android-apk/android/app/build/outputs/apk/release/app-release.apk','PocketEngineer-0.4.0-android-'+(signing==='project-release-key'?'release':'preview')+'.apk'],
  ['pocket-engineer-windows-latest/PocketEngineer-0.4.0-win64.zip','PocketEngineer-0.4.0-Windows-x64.zip'],
  ['pocket-engineer-macos-latest/PocketEngineer-0.4.0-Darwin.zip','PocketEngineer-0.4.0-macOS-universal.zip'],
  ['pocket-engineer-ubuntu-latest/PocketEngineer-0.4.0-Linux.zip','PocketEngineer-0.4.0-Linux-x64.zip']
];
...
execFileSync('zip',['-q','-r',path.join(target,'PocketEngineer-0.4.0-offline-website.zip'),'.'],{cwd:path.resolve(website)});
